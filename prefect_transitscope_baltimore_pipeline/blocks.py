...
class TransitscopebaltimorepipelineBlock(Block):
    ...
    Example:
        Load a stored value:
        ```python
        from prefect_transitscope_baltimore_pipeline import TransitscopebaltimorepipelineBlock
        block = TransitscopebaltimorepipelineBlock.load("BLOCK_NAME")
        ```
    """

    _block_type_name = "transitscope baltimore pipeline"
    ...
    _documentation_url = "https://fedderw.github.io/prefect-transitscope-baltimore-pipeline/blocks/#prefect-transitscope-baltimore-pipeline.blocks.TransitscopebaltimorepipelineBlock"  # noqa
